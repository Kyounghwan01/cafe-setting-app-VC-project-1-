...
import { LOGIN_LOGO, ROUTE_MAIN, ROUTE_SIGN_UP } from "constants/state";
...
const Login = () => {
  ...
  return (
    <div className="Login-container">
      <Header element={[ROUTE_MAIN, ROUTE_SIGN_UP]} />
      <div className="sign-container">
        ...
        <div className="sign-body">
          ...
          <form
            ...
            action="http://itsmyseatvcserver-env.drc3wmhbci.ap-northeast-2.elasticbeanstalk.com/api/login"
            method="POST"
          >
            <div className="group">
              <input
