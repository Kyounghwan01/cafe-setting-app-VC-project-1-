...
describe('renders without crashing', () => {
  let node = {label : 'MENU', state : 'open', children : [
    {label : 'cake', children : [
      {label : 'greenTea', price : 5000, id : "5da81701e4b6d10bddb3c41e", desc : '맛좋은 뭐시기'}
    ]}
  ]}
  let tocken = "?eyJhbGciOiJIUzI1NiJ9.MkAy.d_qbeutN2iXsAY6uMXHYd7ea-UkW-1ED8qK_ANae9NU"
  ...
  it('should have element', () => {
    ...
    const text = wrapper.find('span[className="name"]').map(node => node.text());
